...
class Provenance extends React.Component {
    ...
    render() {
        const { addEdgeMode, dltRelationsBtn, drawerLoading, dropdownSelectValue, provEditorModal, relationMode, relFrom, relTo, relMsg, selectedEdge, showProvDetails, toggleProv, toggleProvEdit } = provenanceStore;
        const { entityObj, fileVersions, projectRole, screenSize } = mainStore;
        ...
        let relationTypeSelect = projectRole === 'project_viewer' ?
