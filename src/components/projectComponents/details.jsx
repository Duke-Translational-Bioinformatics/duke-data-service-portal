                        ...
                        { projectMembers.map((users)=> {
                            ...
                            return <li key={users.user.id}>
                                <div style={styles.iconContainer}>
                                    <a onTouchTap={() => this.deleteUser(users.user.id, users.user.full_name, removeSelf)} style={styles.deleteIcon.wrapper}>
                                        {showIcons ? <i className="material-icons" style={styles.deleteIcon}>cancel</i> : ''}</a>
                                    <a onTouchTap={() => this.changeRole(users.user.id, users.user.full_name, users.auth_role.id)}>
