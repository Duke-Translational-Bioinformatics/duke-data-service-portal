...
export class NavigatorStore {
    ...
    @action setProjectRole(currentProject) {
        ...
        currentProjectRole ? mainStore.projectRole = projRolesCoversion[currentProjectRole] : mainStore.getPermissions(currentProject.id, authStore.currentUser.id);
    }
